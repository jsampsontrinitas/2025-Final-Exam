...
export default {
    ...
    tests: [
        ...
        },
        {
            ...
            "fn": () => {
                const html = cleanIndents(document.documentElement);
                const head = cleanIndents(document.head);
                const body = cleanIndents(document.body);
